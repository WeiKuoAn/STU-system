            ...
            <div class="flex">
                ...
                @if (Auth::user()->status == '0')
                    @if (Auth::user()->level == '2')
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-nav-link :href="route('personwork')" :active="request()->routeIs('personwork')">
                                {{ __('出勤紀錄') }}
                            </x-nav-link>
                        </div>
                    ...
                    @endif
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('worksheet')" :active="request()->routeIs('worksheet')">
                            {{ __('工作紀錄表') }}
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('person', Auth::user()->id)" :active="request()->routeIs('person')">
                            {{ __('個人資料') }}
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('editpassword', Auth::user()->id)" :active="request()->routeIs('editpassword')">
                            {{ __('修改密碼') }}
                        </x-nav-link>
                    </div>
